 ...
 * 
 * @author KRISHNENDU
 * @category Encypter for authentication. Generates encrypted password and decrypt as well.
 * 
 * */
...
public class Encrypter {
	...
	public static void main(String[]arg) throws Exception {
		...
		String target = "Adm!nUser05";
		String encryptedString = encryption.encrypt(target);
